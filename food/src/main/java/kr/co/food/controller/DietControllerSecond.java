...
@Controller
public class DietControllerSecond {
	@Autowired
	public SqlSession sqlSession;
	
	@RequestMapping("/diet/test_index")
	public String test_index(Model model) {
		
		return "/diet/test_index";
	}
	@RequestMapping("/diet/test_view")
	public String test_view(HttpServletRequest request, Model model) {
